...
namespace ISSV.Views
{
    ...
    public sealed partial class ShellPage : Page, INotifyPropertyChanged
    {
        ...
        {
            Thickness margin = AppTitleBar.Margin;
            AppTitleBar.Margin = new Thickness(margin.Left, margin.Top, coreTitleBar.SystemOverlayRightInset, margin.Bottom);
        }

        private void UpdateAppTitleMargin(WinUI.NavigationView sender)
        {
        ...
        private void NavigationView_DisplayModeChanged(WinUI.NavigationView sender, WinUI.NavigationViewDisplayModeChangedEventArgs args)
        {
            ...
            {
                AppTitleBar.Margin = new Thickness((sender.CompactPaneLength * 2), margin.Top, margin.Right, margin.Bottom);
            }
            else
            {
                AppTitleBar.Margin = new Thickness(sender.CompactPaneLength, margin.Top, margin.Right, margin.Bottom);
            }
            UpdateAppTitleMargin(sender);
        }
    }
